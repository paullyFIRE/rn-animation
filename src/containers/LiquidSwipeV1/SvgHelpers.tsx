// https://github.com/wcandillon/can-it-be-done-in-react-native/blob/master/season3/src/LiquidSwipe/SVGHelpers.ts
...
export const curveTo = (commands: Animated.Node<string>[], c: Curve) => {
  commands.push(string`C${c.c1.x},${c.c1.y} ${c.c2.x},${c.c2.y} ${c.to.x},${c.to.y} `)
}
